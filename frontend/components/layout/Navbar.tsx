            ...
            <>
              <li>
                <div className="px-4 py-3 flex items-center gap-3 border-t border-sand dark:border-[#333] mt-3 pt-4">
                  <div className="w-9 h-9 rounded-full bg-[#F4C430] flex items-center justify-center ring-2 ring-[#0D3B2A] ring-offset-1 text-[#0D3B2A] text-xs font-bold font-sans tracking-wide">
                    {initials}
                  </div>
                  <div>
