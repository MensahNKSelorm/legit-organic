        ...
        <div className="hidden md:flex items-center gap-3 shrink-0 justify-end" style={{ minWidth: '160px' }}>
          ...
          {isAuthenticated && user ? (
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#0D3B2A] to-[#2E7D32] flex items-center justify-center ring-2 ring-[#F4C430] ring-offset-1 text-white text-xs font-bold tracking-wider">
                  {initials}
                </div>
                <span
            ...
            <>
              <li>
                <div className="px-4 py-3 flex items-center gap-3 border-t border-sand dark:border-[#333] mt-3 pt-4">
                  <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#0D3B2A] to-[#2E7D32] flex items-center justify-center ring-2 ring-[#F4C430] ring-offset-1 text-white text-xs font-bold tracking-wider">
                    {initials}
                  </div>
                  <div>
