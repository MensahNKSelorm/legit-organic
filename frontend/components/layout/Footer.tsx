          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#F4C430] hover:text-[#0D3B2A] flex items-center justify-center transition-colors duration-200 text-white"
              >
