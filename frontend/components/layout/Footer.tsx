...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: "#0D3B2A", color: "#FEFCF7" }}>
      <div
        className="page-container mx-auto max-w-7xl px-6 lg:px-8"
      ...
      >
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-5">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-light-leaf mb-6 text-sm leading-relaxed">
            ...
            <div className="flex gap-3">
              <a
                href="https://x.com/legitorganicltd"
                aria-label="Follow us on Twitter"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white transition-colors duration-200 hover:bg-[#F4C430] hover:text-[#0D3B2A]"
              >
              ...
              <a
                href="https://instagram.com/legitorganic_ltd"
              ...
              <a
                href="https://facebook.com/legitorganic9"
              ...
              <a
                href="https://tiktok.com/@legit.organic.ltd"
              ...
              >
                {links.map((link) => (
                  <li key={`${category}-${link.label}`}>
                    <Link
                      href={link.href}
                      className="text-light-leaf hover:text-mist-white text-sm transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        >
          ...
          <div style={{ display: "flex", gap: "1.5rem" }}>
            <Link
              href="/privacy-policy"
              className="text-light-leaf hover:text-mist-white transition-colors"
              style={{ fontSize: "0.75rem" }}
            >
              Privacy Policy
            </Link>
