    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#FAF7F0] dark:bg-[#111827] px-6">
        <div className="max-w-md w-full text-center bg-white dark:bg-[#1f2937] rounded-2xl border border-[#E6D8BD] dark:border-[#374151] p-10">
          ...
          <h1 className="font-display text-xl font-bold text-[#0D3B2A] dark:text-white mb-2">
            Invalid Link
          </h1>
          <p className="text-sm text-[#5B3E31] dark:text-[#9ca3af] mb-6">
            This password setup link is missing required parameters. Please use the link from your
            approval email.
          </p>
          <Link
            href="/b2b"
            className="text-sm text-[#2E7D32] dark:text-[#81C784] hover:underline font-semibold"
          >
            Back to B2B Portal
          </Link>
        </div>
