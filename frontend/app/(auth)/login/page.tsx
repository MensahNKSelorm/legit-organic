  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (lower.includes("verify your email")) {
        ...
        setError(
          lower.includes("no active account") ? "Invalid email or password. Please try again." : msg
        );
      }
    } finally {
      setLoading(false);
  ...
  return (
    <div className="grid min-h-screen bg-[#FAF7F0] pt-[76px] dark:bg-[#171B18] lg:grid-cols-2">
      <div className="relative hidden min-h-[calc(100vh-76px)] overflow-hidden bg-[#0D3B2A] lg:block">
        ...
        <p className="display-organic absolute bottom-14 left-14 max-w-lg text-5xl leading-[.95] text-white">
          Good to have you <em className="font-normal text-[#F4C430]">back at the market.</em>
        </p>
      </div>
      <div className="flex items-center justify-center px-7 py-16 sm:px-10 md:px-14 lg:px-16 xl:px-24">
        <div className="w-full max-w-lg">
          ...
          <div className="mb-10">
            ...
            <h1 className="display-organic text-5xl text-[#0D3B2A] dark:text-[#FEFCF7]">
              Welcome back.
            </h1>
            <p className="mt-3 text-[#5B3E31] dark:text-[#B8D4BD]">
              Sign in to continue shopping, cooking and tracking orders.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="relative flex items-center mb-6">
              ...
              <span className="px-3 text-xs text-[#5B3E31] dark:text-[#B8D4BD]">
            ...
            <p className="text-center text-sm text-charcoal/60 mt-6">
              ...
              <Link
                href="/signup"
                className="text-leaf-green font-semibold hover:text-forest-green transition-colors"
              >
                Create one
              </Link>
            </p>
