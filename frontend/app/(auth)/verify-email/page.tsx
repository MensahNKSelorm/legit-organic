...
function Spinner() {
  return (
    <span
      className="inline-block w-8 h-8 border-[3px] border-forest-green border-t-transparent rounded-full animate-spin"
      aria-hidden
    />
  );
}
        ...
        <div className="bg-mist-white rounded-2xl p-10 border border-sand shadow-sm text-center">
          ...
          {state === "success" && (
            <>
              ...
              <p className="text-charcoal/50 text-sm">Redirecting to your profile...</p>
            </>
          )}
