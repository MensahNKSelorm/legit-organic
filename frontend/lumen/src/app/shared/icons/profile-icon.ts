...
@Component({
  ...
  template: `
    <svg class="icon-svg" viewBox="0 0 24 24" width="18" height="24">
            <path fill="currentColor" d="M16,14c-3.8598633,0-7-3.140625-7-7s3.1401367-7,7-7s7,3.140625,7,7S19.8598633,14,16,14z M16,2
              c-2.7568359,0-5,2.2431641-5,5s2.2431641,5,5,5s5-2.2431641,5-5S18.7568359,2,16,2z" />
            <path fill="currentColor" d="M27,32c-0.5522461,0-1-0.4472656-1-1v-6.1152344c0-3.828125-3.1142578-6.9423828-6.9423828-6.9423828h-6.1152344
