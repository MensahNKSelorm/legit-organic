...
ORDERS_FROM_EMAIL = os.getenv('ORDERS_FROM_EMAIL', 'orders@legitorganic.com')
UPDATES_FROM_EMAIL = os.getenv('UPDATES_FROM_EMAIL', 'updates@legitorganic.com')
BUSINESS_FROM_EMAIL = os.getenv('BUSINESS_FROM_EMAIL', 'operations@legitorganic.com')
SUPPORT_REPLY_TO_EMAIL = os.getenv('SUPPORT_REPLY_TO_EMAIL', 'support@legitorganic.com')
ORDER_REPORT_EMAIL = os.getenv('ORDER_REPORT_EMAIL', 'legitorganic9@gmail.com')
BUSINESS_REPLY_TO_EMAIL = os.getenv('BUSINESS_REPLY_TO_EMAIL', 'operations@legitorganic.com')
...
UNFOLD = {
    ...
    "STYLES": [
        lambda request: f'{static("admin/css/legitorganic-admin.css")}?v=20260904-2',
    ],
    "SCRIPTS": [
        lambda request: f'{static("admin/js/legitorganic-admin.js")}?v=20260904-2',
    ],
    "SHOW_HISTORY": True,
...
if os.getenv('DB_ENGINE', 'postgresql').strip().lower() == 'sqlite':
    DATABASES = {
        'default': {
